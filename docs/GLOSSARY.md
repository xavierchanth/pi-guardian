...
| **thinker** | Root agent responsible for user intent, routing, workspace custody, review decisions, integration, and final verification. |
| **planner** | Agent owning one substantial isolated workspace slice, including decomposition and implementation within that slice. |
| **worker** | Agent owning one bounded implementation assignment. |
