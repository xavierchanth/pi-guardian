...
export const ProtocolRangeSchema: z.ZodType<ProtocolRange> = z.object({
  minVersion: safeUInt,
  maxVersion: safeUInt,
}).strict().refine((range) => range.minVersion <= range.maxVersion, {
  message: "minVersion must not exceed maxVersion",
});

export const RuntimeProtocolErrorSchema: z.ZodType<RuntimeProtocolError> = z.object({
  code: nonEmptyString,
...
export const RuntimeCommandSchema: z.ZodType<RuntimeCommand> = z.object({
...
export const RuntimeResponseSchema: z.ZodType<RuntimeResponse> = z.object({
  ...
  if (response.ok && response.error !== undefined) {
    context.addIssue({ code: "custom", message: "successful responses cannot include error", path: ["error"] });
  }
  if (!response.ok && response.error === undefined) {
    context.addIssue({ code: "custom", message: "failed responses require error", path: ["error"] });
  }
});
...
export const RuntimeInitializeParamsSchema: z.ZodType<RuntimeInitializeParams> = z.object({
...
export const SessionPromptParamsSchema: z.ZodType<SessionPromptParams> = z.object({
  turnId: nonEmptyString,
  text: nonEmptyString,
}).strict();

export const SessionTextParamsSchema: z.ZodType<SessionTextParams> = z.object({
  text: nonEmptyString,
}).strict();
...
export const SessionSetThinkingParamsSchema: z.ZodType<SessionSetThinkingParams> = z.object({
...
export const RuntimeInitializeResultSchema: z.ZodType<RuntimeInitializeResult> = z.object({
  protocolVersion: z.literal(CURRENT_RUNTIME_PROTOCOL_VERSION),
  workerId: nonEmptyString,
  runtimeGeneration: safeUInt,
...
export const AcceptedResultSchema: z.ZodType<AcceptedResult> = z.object({ accepted: z.boolean() }).strict();
export const EmptyResultSchema: z.ZodType<EmptyResult> = strictEmpty;
export const ModelInfoSchema: z.ZodType<ModelInfo> = z.object({ provider: nonEmptyString, model: nonEmptyString }).strict();
export const ThinkingInfoSchema: z.ZodType<ThinkingInfo> = z.object({ level: ThinkingLevelSchema }).strict();
export const TextDeltaDataSchema: z.ZodType<TextDeltaData> = z.object({ delta: z.string() }).strict();
export const ToolLifecycleDataSchema: z.ZodType<ToolLifecycleData> = z.object({
  toolCallId: nonEmptyString,
  toolName: nonEmptyString,
  isError: z.boolean().optional(),
}).strict();
export const QueueDataSchema: z.ZodType<QueueData> = z.object({
  steeringCount: safeUInt,
  followUpCount: safeUInt,
}).strict();
export const SessionTitleDataSchema: z.ZodType<SessionTitleData> = z.object({ title: z.string().optional() }).strict();
export const InterruptionDataSchema: z.ZodType<InterruptionData> = z.object({ reason: nonEmptyString }).strict();
