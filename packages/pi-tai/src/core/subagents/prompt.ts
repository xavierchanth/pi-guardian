...
export const DELEGATION_GUIDELINES: readonly string[] = [
  ...
  "Respond normally to foreground user input. Before allowing the agent run to settle, if any subagents are still running, call subagent_wait for all running subagents. Repeat until none remain.",
